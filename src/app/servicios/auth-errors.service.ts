...
export class AuthErrorsService {
  ...
  getError(errorCode) {
    const FIREBASE_ERROR_LIST = {
      ...
      'auth/insufficient-permission': 'La credencial que se usó para inicializar el SDK de Admin no tiene permisos suficientes.',
      ...
      'auth/invalid-email': '	La dirección de correo electrónico ingresada no es valida.',
      ...
      'auth/invalid-session-cookie-duration': 'La duración de las cookies de la sesión debe ser un número válido en milisegundos que vaya entre los 5 minutos y las 2 semanas.',
      ...
      'auth/user-not-found': 'El correo electrónico proporcionado no corresponde a un usuario activo'
    } as FirebaseErrors;

    return FIREBASE_ERROR_LIST[errorCode];
  }
}
